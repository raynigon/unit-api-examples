...
dependencies {
    ...
    implementation("com.raynigon.unit-api:spring-boot-jpa-starter:3.0.7")
    implementation("com.raynigon.unit-api:spring-boot-springdoc-starter:3.0.7")
    implementation("com.raynigon.unit-api:unit-api-kotlin:3.0.7")
